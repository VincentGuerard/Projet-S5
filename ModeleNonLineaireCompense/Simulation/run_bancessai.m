...
t_des     = [0:1:2]'*5;
x_des     = [t_des, [0 0 1]'*0.05];
y_des     = [t_des, [0 1 0]'*0.05];
...
figure; hold on; plot((0:1:14), [1 1 1 1 1 0.5 0.5 0.5 0.5 0.5 1 1 1 1 1]*0.015, 'b--', 'Linewidth', 2); plot(tsim, ySystemeNonLineaire(:,10),'b')
legend('z_d_e_s', 'Pz')
hold off
