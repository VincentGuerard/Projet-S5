...
figure; hold on; plot(pole_des_angle, 'p'); rlocus(FTplaque(1,1));
title('Lieu des racines \phi / V_\phi et pôles désirés')
figure; hold on; plot(pole_des_angle, 'p'); rlocus(FTplaque(1,1));
title('Lieu des racines \theta / V_\theta et pôles désirés')
%Les pôles désirés sont placés à gauche des tracés dominant, donc un
%compensateur est nécessaire
